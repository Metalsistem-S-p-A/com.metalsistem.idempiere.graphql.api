...
public class IDempiereGraphQLException extends AdempiereException {
	 ...
	 */
	public IDempiereGraphQLException(String message, Status error) {
		super(message);
	 ...
	 * @param error -> Response status error
	 */
	public IDempiereGraphQLException(String title, String message, Status error) {
		super(message);
		setErrorResponseStatus(error);
		setTitle(title);
	}
