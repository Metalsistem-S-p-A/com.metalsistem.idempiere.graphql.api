...
public class SysConfigTokenSecretProvider implements ITokenSecretProvider {
	...
	public static final String GRAPHQL_TOKEN_SECRET = "GRAPHQL_TOKEN_SECRET";

	private SysConfigTokenSecretProvider() {
		String secret = MSysConfig.getValue(GRAPHQL_TOKEN_SECRET);
		if (secret == null) {
			...
			sysConfig.setName(GRAPHQL_TOKEN_SECRET);
	...
	public String getSecret() {
		return MSysConfig.getValue(GRAPHQL_TOKEN_SECRET);
	}
